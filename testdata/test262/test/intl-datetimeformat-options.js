...
// Time, 12- and 24-hour.
assert.sameValue(dtf({ hour: "2-digit", minute: "2-digit", second: "2-digit" }), "02:30:45" + NN + "PM", "12-hour default");
assert.sameValue(dtf({ hour: "numeric", minute: "2-digit", hour12: true }), "2:30" + NN + "PM", "numeric hour 12h");
...
assert.sameValue(h12(Date.UTC(2024, 0, 1, 0, 0)), "12" + NN + "AM", "midnight -> 12 AM");
assert.sameValue(h12(Date.UTC(2024, 0, 1, 12, 0)), "12" + NN + "PM", "noon -> 12 PM");
...
assert.sameValue(dtf({ timeStyle: "short" }), "2:30" + NN + "PM", "timeStyle short");
