...
const CONFORMANCE = {
  ...
  ledger: 48,
  clusters: [
    { name: 'intl402/RelativeTimeFormat', count: 6 },
    { name: 'intl402/NumberFormat', count: 5 },
    { name: 'intl402/Collator', count: 4 },
    { name: 'intl402/DateTimeFormat', count: 4 },
    { name: 'intl402/Intl', count: 4 },
  ],
};
