...
impl<'a> Interp<'a> {
    ...
    pub(crate) fn instant_construct(
        ...
        Err(self.temporal_todo("Instant constructor"))
    }
    ...
    pub(crate) fn instant_method(
        ...
        Err(self.temporal_todo(&alloc::format!("Instant.prototype.{method}")))
    }
    ...
    pub(crate) fn instant_getter(
        ...
        Err(self.temporal_todo(&alloc::format!("Instant getter {name}")))
    }
